...
def signup():
    ...
    value = {'vendorid' :'1' ,'storename' : 'MAD','storeid' : '200','city' : 'Chennai','branch' : 'Race Club','state' : 'TamilNadu'}
    head = {'Content-Type' : 'application/json'}
    r=requests.post(url, data=json.dumps(value), headers=head) 
    return r.text
...
def info():
    ...
    value = {'vendorid' : 1 ,'storeid' : "all" }
    head = {'Content-Type' : 'application/json'}
    r=requests.get(url, data=json.dumps(value), headers=head) 
    return r.text
...
def update():
    ...
    value = {'vendorid' : 1 ,'storename' : 'grey','storeid' : 5200,'city' : 'Chennai','branch' : 'Poes','state' : 'Tamilnadu'}
    head = {'Content-Type' : 'application/json'}
    r=requests.get(url, data=json.dumps(value), headers=head) 
    return r.text
